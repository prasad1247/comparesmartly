...
//        inputMap.put(ProductHelper.orderclause, "cast(f16 as decimal(10,2)) desc");
            ...
            String cat_name = "Best mobile phones under Rs. " + cat_price + "";
            String cat_name7 = "<strong>Best phones under Rs. " + cat_price + "</strong>";
            String cat_name1 = "Phones with best features under Rs. " + cat_price;
            String cat_name4 = "Smartphones having top specs under " + cat_price;
            String cat_name2 = "<strong>Best mobiles under " + cat_price + "</strong>";
            String cat_name3 = "<strong>Top mobile phones below Rs. " + cat_price + "</strong>";
            String cat_name5 = "Top mobile phones below " + cat_price;
            String cat_name6 = "Top phones under " + cat_price1;
//            String cat_name1 = "Best Samsung mobile price in range 10000 to 15000";
//            String cat_name4 = "Top Samsung phones between 10000 to 15000";
//            String cat_name2 = "<strong>Samsung mobile range 10000 to 15000</strong>";
//            String cat_name3 = "<strong>Samsung mobile between 10000 to 15000</strong>";
//            String cat_name5 = "Best Samsung mobile price 10000 to 15000";

            String[] cat_names = {cat_name, cat_name1, cat_name2, cat_name3, cat_name4, cat_name5, cat_name6, cat_name7};
            String cat_s_name = "<strong>Best phone under Rs. " + cat_price + "</strong>";
            String cat_s_name1 = "smartphone with best features under Rs. " + cat_price;
            String cat_s_name2 = "<strong>Top smartphone under " + cat_price + "</strong>";
            String cat_s_name3 = "<strong>Best smartphone below " + cat_price + "</strong>";
            String cat_s_name4 = "<strong>Top mobile below " + cat_price + "</strong>";
            String cat_s_name5 = "<strong>Top mobile phone below " + cat_price1 + "</strong>";
//            String cat_s_name = "<strong>Best Samsung phone in range 10000 to 15000</strong>";
//            String cat_s_name1 = "Top Samsung phones between 10000 to 15000";
//            String cat_s_name2 = "<strong>Best Samsung mobile price 10000 to 15000</strong>";
//            String cat_s_name3 = "<strong>Best Samsung mobile in 10000 to 15000 range</strong>";
//            String cat_s_name4 = "<strong>Best Samsung mobile in price between 10000 to 15000</strong>";
...
//        }
            ...
            String[] dateS={"Dec 07, 2016","Dec 08, 2016","Dec 09, 2016","Dec 10, 2016"};
            String ddd=dateS[0];
        ...
        lastLine+="<meta itemprop=\"datePublished\" content=\"2016-10-23\">";
