        ...
        <div class="container-fluid">
           Add Category
            <div class="row row-eq-height">
                <div class="col-lg-2">cat_id  <input type="text" name="cat_id" id="cat_id" value=""></div>
                <div class="col-lg-2">cat_name <input type="text" name="cat_name" id="cat_name" value=""></div>
                <div class="col-lg-2">s_cat_name <input type="text" name="s_cat_name" id="s_cat_name" value=""></div>
                <div class="col-lg-6">               
                </div> 
            </div>
