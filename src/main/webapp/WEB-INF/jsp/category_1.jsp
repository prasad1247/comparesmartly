...
<html lang="en">
    ...
    <head>
        ...
        <meta name="author" content="CompareSmartly">
	<link rel="publisher" href="https://plus.google.com/b/103002664307398997051">
        <title><%=title%></title>
    ...
    <body style="background-color: #F5F7F5; overflow-x: hidden">
                    ...
                    <div class="panel panel-default" >
                        <div class="panel-body">
                            <%   if (clId == 0) {%><% if (pBean.getBrandCatDesc() != null) {
                                    out.print("<div  itemscope itemtype=\"http://schema.org/Article\">" + pBean.getBrandCatDesc());%>
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                %>
                <div class="row row-eq-height" itemprop="itemListElement"  itemscope itemtype="http://schema.org/Product">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="col-lg-2 col-xs-3">
                                ...
                                <div class="">
                                    <a href="${pageContext.request.contextPath}/<%=pb.getpUrl()%>" title="<%=pb.getProductName()%>">
                                        <img itemprop="image" class="img img-responsive" style="max-height: 200px" src="<%=pb.getImgLink()%>" alt="<%=pb.getProductName()%>">
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-10">
                                <div class="row">
                                    <div class="col-lg-7 col-xs-9">
                                        <h4><a itemprop="url" href="${pageContext.request.contextPath}<%="/" + pb.getpUrl()%>"><span  itemprop="name"><%=pb.getProductName()%></span></a></h4>
                                        <p itemprop="brand"><%=pb.getBrandName()%></p>
                                    </div>
                                    <div class="col-lg-3 col-xs-5">
                                        <div class="large-text" itemprop="offers" itemscope itemtype="http://schema.org/Offer" style="color:forestgreen"><span itemprop="priceCurrency" content="INR"><i class="fa fa-inr" aria-hidden="true"></i></span>.<span itemprop="price" content="<%=pb.getNewPrice()%>"><%=pb.getNewPrice()%></span></div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <% for (String data : sList) {
                                            ...
                                            out.print("<tr itemprop=\"additionalProperty\" itemscope itemtype=\"http://schema.org/PropertyValue\"><td > " + glyph + " </td><td > <strong><span itemprop=\"name\"> " + fname + "</span> </strong> </td><td><span itemprop=\"value\">" + fval + "</span></td></tr>");
                                        }%>
                                ...
                                <div class="row">
				                                        ...
				                                        <div class="col-lg-4 col-xs-12">
				                                            <% int listSize= pb.getpListDesc().size();
